...
import PlaneSmall from "../components/icons/PlaneSmall";
import Meal from "../components/icons/Meal";
...
const Trips: React.FC = () => {
    ...
    return (
        <section className="container overflow-hidden md:overflow-visible md:py-20! py-5!">
            {/* Section Header */}
